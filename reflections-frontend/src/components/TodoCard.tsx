								...
								<div className="relative" key={item.id}>
									<li>
										<textarea
											...
											bg-transparent py-2 pl-2 pr-2 font-serif text-xl/[33px] font-medium tracking-tight text-[#E0E5F1] focus:outline-none`}
											spellCheck={false}
											disabled={status}
											onChange={(event) =>
								...
								<div className="relative" key={item.id}>
									<li>
										<textarea
											...
											style={{ height: item.height }}
											value={item.content}
											className={`border-1 z-10 w-full resize-none scroll-smooth rounded-xl border border-stone-600 border-opacity-70 bg-transparent py-2 pl-2 pr-2 font-serif text-xl/[33px] font-medium tracking-tight text-[#E0E5F1] line-through decoration-[#E0E5F1] decoration-2 focus:outline-none`}
											spellCheck={false}
											disabled={item.done}
											onChange={(event) =>
												handleListUpdate(item.id, event)
