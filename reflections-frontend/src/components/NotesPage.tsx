	...
	return (
		<div className={`flex items-center bg-[#161616]`}>
			...
			>
				...
				<Navigator />
				<div className="overflow-x-none flex h-3/4 w-2/3 items-center justify-center rounded-2xl bg-transparent text-center font-inter text-5xl/[46px] font-bold tracking-tighter text-white backdrop-blur-lg">
					<NotesUpdated />
				</div>
			</div>
		</div>
