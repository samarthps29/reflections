	...
	return (
		<div className={`flex items-center bg-[#161616]`}>
			...
			>
				...
				<div className="z-10 flex h-5/6 w-11/12 items-center justify-center rounded-2xl bg-stone-400 bg-opacity-0 text-center font-inter text-5xl/[46px] font-bold tracking-tighter text-white">
					<NotesCard />
				</div>
			</div>
		</div>
